...
var multiplayer_scene = preload("res://planes/main_plane.tscn")
var multiplayer_peer: SteamMultiplayerPeer = SteamMultiplayerPeer.new()
var _players_spawn_node
var _hosted_lobby_id = 0

const LOBBY_NAME = "Fadin é gay"
const LOBBY_MODE = "PEPINO"
...
func become_host():
	...
	multiplayer_peer.create_lobby(SteamMultiplayerPeer.LOBBY_TYPE_PUBLIC, 10)
...
func list_lobbies():
	...
	Steam.addRequestLobbyListStringFilter("name", "Fadin é gay", Steam.LOBBY_COMPARISON_EQUAL)
